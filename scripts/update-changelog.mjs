 ...
 *
 * Run by the deploy workflow before its commit-back step, so the changelog
 * stays current without anyone maintaining it. The workflow's own commit lands
 * in the NEXT run's entries (a file cannot contain its own commit); that one-
 * commit lag is inherent and harmless.
 *
